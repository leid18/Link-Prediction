...
/**
 *This Hadoop Map Reduce code is to do the Common Neighbours link prediction. It will calculate score of the Jaccard similarity between nodes from a dataset
...
public class CNMapRed extends Configured implements Tool {
    ...
    public static class PassOneReduce extends MapReduceBase implements Reducer<Text, Text, Text, PairNodes>{
         ...
         *The file of the output will be in the "cn1" folder.
         */
    ...
    public static class PassTwoReduce extends MapReduceBase implements Reducer<Text, PairNodes, Text,  Text>{
         ...
         *The output file will be in the "cn2" folder
         */
    ...
    public static class PassThreeReduce extends MapReduceBase implements Reducer<Text, IntWritable, Text, FloatWritable>{
        /**
         *The reduce function is to calculate the final result of the Common Neighbours algorithm.
         */
    ...
    public static void main(String[] args) throws Exception {
        int res = ToolRunner.run(new Configuration(), new CNMapRed(), args);
        System.exit(res);
	   }
    ...
    public void pass1() throws Exception{
        JobConf conf= new JobConf(CNMapRed.class);
        conf.setJobName("Common Neighbours Step1");
        ...
        FileOutputFormat.setOutputPath(conf, new Path("cn1"));
        
        JobClient.runJob(conf);
    }
    
    public void pass2() throws Exception{
        JobConf conf2= new JobConf(CNMapRed.class);
        conf2.setJobName("Common Neighbours Step2");
        ...
        FileInputFormat.setInputPaths(conf2, new Path("cn1"));
        FileOutputFormat.setOutputPath(conf2, new Path("cn2"));
        
        JobClient.runJob(conf2);
    }
    
    public void pass3() throws Exception{
        JobConf conf3= new JobConf(CNMapRed.class);
        conf3.setJobName("Common Neighbours Step3");
        ...
        FileInputFormat.setInputPaths(conf3, new Path("cn2"));
        FileOutputFormat.setOutputPath(conf3, new Path("CNoutput"));
        
        JobClient.runJob(conf3);
    }
    
    public void pass4() throws Exception{
        JobConf conf4= new JobConf(CNMapRed.class);
        conf4.setJobName("Common Neighbours Step4");
        ...
        FileInputFormat.setInputPaths(conf4, new Path("CNoutput"));
        FileOutputFormat.setOutputPath(conf4, new Path("CNoutput2"));
