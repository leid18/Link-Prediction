...
/**
 *This Hadoop Map Reduce code is to do the Preferential Attachment link prediction. It will calculate score of the Jaccard similarity between nodes from a dataset
...
public class PAMapRed extends Configured implements Tool {
    ...
    public static class PassOneReduce extends MapReduceBase implements Reducer<Text, Text, Text, PairNodes>{
         ...
         *The file of the output will be in the "pa1" folder.
         */
    ...
    public static class PassTwoReduce extends MapReduceBase implements Reducer<Text, PairNodes, Text,  Text>{
         ...
         *The output file will be in the "pa2" folder
         */
    ...
    public static class PassThreeReduce extends MapReduceBase implements Reducer<Text, IntWritable, Text, FloatWritable>{
        /**
         *The reduce function is to calculate the final result of the Preferential Attachment algorithm.
         */
        public void reduce(Text key, Iterator<IntWritable> valueList, OutputCollector<Text, FloatWritable> output, Reporter reporter) throws IOException{
            float paResult = 0;
            while (valueList.hasNext()){
                paResult = (float)valueList.next().get();
                
            }
            //float totalCounts = sumCounts - count;
            FloatWritable newValue = new FloatWritable(paResult);
    ...
    public static void main(String[] args) throws Exception {
        int res = ToolRunner.run(new Configuration(), new PAMapRed(), args);
        System.exit(res);
	   }
    ...
    public void pass1() throws Exception{
        JobConf conf= new JobConf(PAMapRed.class);
        conf.setJobName("Preferential Attachment Step1");
        ...
        FileOutputFormat.setOutputPath(conf, new Path("pa1"));
        
        JobClient.runJob(conf);
    }
    
    public void pass2() throws Exception{
        JobConf conf2= new JobConf(PAMapRed.class);
        conf2.setJobName("Preferential Attachment Step2");
        ...
        FileInputFormat.setInputPaths(conf2, new Path("pa1"));
        FileOutputFormat.setOutputPath(conf2, new Path("pa2"));
        
        JobClient.runJob(conf2);
    }
    
    public void pass3() throws Exception{
        JobConf conf3= new JobConf(PAMapRed.class);
        conf3.setJobName("Preferential Attachment Step3");
        ...
        FileInputFormat.setInputPaths(conf3, new Path("pa2"));
        FileOutputFormat.setOutputPath(conf3, new Path("PAoutput"));
        
        JobClient.runJob(conf3);
    }
    
    public void pass4() throws Exception{
        JobConf conf4= new JobConf(PAMapRed.class);
        conf4.setJobName("Preferential Attachment Step4");
        ...
        FileInputFormat.setInputPaths(conf4, new Path("PAoutput"));
        FileOutputFormat.setOutputPath(conf4, new Path("PAoutput2"));
